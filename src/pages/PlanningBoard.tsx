...
const PlanningBoard = () => {
  const members = [
    ...
    { id: 2, name: "Prof. (Dr.) Nandini C.P.", designation: "Professor, DSNLU" },
    { id: 3, name: "Dr. Dayananda Murthy C.P.", designation: "Associate Professor, DSNLU" },
    { id: 4, name: "Dr. K. Sudha", designation: "Dean Examinations, DSNLU" },
    { id: 5, name: "Dr. B. Soma", designation: "Dean Academic Affairs, DSNLU" },
    { id: 6, name: "Prof. Kondaiah Jonnalagadda", designation: "Head Department of Law, Maharashtra National Law University, Aurangabad" },
    { id: 7, name: "Sri Y Ravi Prasad", designation: "Sr. Advocate, High Courts of Andhra Pradesh and Telangana" },
    { id: 8, name: "Prof. Sri krishna Deva Rao", designation: "Vice-Chancellor, NALSAR University of Law" },
    { id: 9, name: "Sri. Rami Reddy Aluru", designation: "Advocate & Member BCI" },
  ];
          ...
          <div className="container max-w-5xl">
            ...
            >
              <div className="text-center">
                <h2 className="font-serif text-3xl font-bold text-foreground capitalize">PLANNING & MONITORING BOARD</h2>
